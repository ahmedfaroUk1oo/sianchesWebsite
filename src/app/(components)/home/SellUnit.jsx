...
<div className="img">
    <Image src='/assets/sell.webp' alt='Sell Unit' loading="lazy" width={656} height={408} className='w-[656px] max-[1350px]:w-[456px] max-[1100px]:w-[300px] h-[408px] m-auto  max-lg:m-auto max-lg:h-full lg:scale-[1.2]' />
</div>
</div>
        </div>
        </section>
